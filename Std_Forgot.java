...
public class Std_Forgot extends JFrame implements ActionListener{
	...
	public char[] Captcha(int length){
		...
		public Std_Forgot(){
			...
			l1=new JLabel("STUDENT FORGOT PASSWORD");
			l2=new JLabel("UserName");
			l3=new JLabel("Std_Id");
						...
						{}
							...
							if(NEWPASSWORD.equals(CONFIRMPASSWORD)){
								if(ENTERCAPTCHA.equals(s)){
																	try{	
					st=con.createStatement();								
					String qry="UPDATE NewStd_Register set PASSWORD='"+NEWPASSWORD+"' where STD_ID="+STD_ID+"";
